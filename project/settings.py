...
while running:
    ...
    text1 = font.render(f"воспроизвести звук пули: {ia}", True, (100, 255, 100))
    text2 = font.render(f"воспроизвести звук башни: {ib}", True, (100, 255, 100))
    text3 = font.render(f"воспроизвести звук врага: {ic}", True, (100, 255, 100))
